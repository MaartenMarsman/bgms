...
// gibbs_sampler_confirmatory_sbm_bw
List gibbs_sampler_confirmatory_sbm_bw(IntegerMatrix observations, IntegerMatrix gamma, NumericMatrix interactions, NumericMatrix thresholds, IntegerVector no_categories, String interaction_prior, double cauchy_scale, NumericMatrix unit_info, NumericMatrix proposal_sd, IntegerMatrix Index, int iter, int burnin, IntegerMatrix n_cat_obs, double threshold_alpha, double threshold_beta, double beta_alpha, double beta_beta, IntegerVector cluster_allocations, bool save, bool display_progress, bool constrained_bw);
RcppExport SEXP _bgms_gibbs_sampler_confirmatory_sbm_bw(SEXP observationsSEXP, SEXP gammaSEXP, SEXP interactionsSEXP, SEXP thresholdsSEXP, SEXP no_categoriesSEXP, SEXP interaction_priorSEXP, SEXP cauchy_scaleSEXP, SEXP unit_infoSEXP, SEXP proposal_sdSEXP, SEXP IndexSEXP, SEXP iterSEXP, SEXP burninSEXP, SEXP n_cat_obsSEXP, SEXP threshold_alphaSEXP, SEXP threshold_betaSEXP, SEXP beta_alphaSEXP, SEXP beta_betaSEXP, SEXP cluster_allocationsSEXP, SEXP saveSEXP, SEXP display_progressSEXP, SEXP constrained_bwSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerMatrix >::type observations(observationsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type save(saveSEXP);
    Rcpp::traits::input_parameter< bool >::type display_progress(display_progressSEXP);
    Rcpp::traits::input_parameter< bool >::type constrained_bw(constrained_bwSEXP);
    rcpp_result_gen = Rcpp::wrap(gibbs_sampler_confirmatory_sbm_bw(observations, gamma, interactions, thresholds, no_categories, interaction_prior, cauchy_scale, unit_info, proposal_sd, Index, iter, burnin, n_cat_obs, threshold_alpha, threshold_beta, beta_alpha, beta_beta, cluster_allocations, save, display_progress, constrained_bw));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bgms_gibbs_sampler_confirmatory_sbm", (DL_FUNC) &_bgms_gibbs_sampler_confirmatory_sbm, 20},
    {"_bgms_gibbs_sampler_confirmatory_sbm_bw", (DL_FUNC) &_bgms_gibbs_sampler_confirmatory_sbm_bw, 21},
