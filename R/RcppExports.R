...
bgmCompare_test_logp_and_gradient <- function(params, observations, group_indices, num_groups, counts_per_category, blume_capel_stats, pairwise_stats, num_categories, is_ordinal_variable, baseline_category, main_effect_indices, pairwise_effect_indices, inclusion_indicator, projection, pairwise_scale = 1.0, difference_scale = 1.0, main_alpha = 1.0, main_beta = 1.0, interaction_prior_type = "cauchy", difference_prior_type = "cauchy", threshold_prior_type = "beta-prime", threshold_scale = 1.0) {
    .Call(`_bgms_bgmCompare_test_logp_and_gradient`, params, observations, group_indices, num_groups, counts_per_category, blume_capel_stats, pairwise_stats, num_categories, is_ordinal_variable, baseline_category, main_effect_indices, pairwise_effect_indices, inclusion_indicator, projection, pairwise_scale, difference_scale, main_alpha, main_beta, interaction_prior_type, difference_prior_type, threshold_prior_type, threshold_scale)
}

run_bgmCompare_parallel <- function(observations, num_groups, counts_per_category, blume_capel_stats, pairwise_stats, num_categories, main_alpha, main_beta, pairwise_scale, difference_scale, difference_selection_alpha, difference_selection_beta, difference_selection_alpha_between, difference_selection_beta_between, difference_dirichlet_alpha, difference_lambda, difference_prior, iter, warmup, na_impute, missing_data_indices, is_ordinal_variable, baseline_category, difference_selection, main_difference_selection, main_effect_indices, pairwise_effect_indices, target_accept, nuts_max_depth, learn_mass_matrix, projection, group_membership, group_indices, interaction_index_matrix, inclusion_probability, num_chains, nThreads, seed, update_method, progress_type, interaction_prior_type_str = "cauchy", difference_prior_type_str = "cauchy", threshold_prior_type_str = "beta-prime", threshold_scale = 1.0, progress_callback = NULL) {
    .Call(`_bgms_run_bgmCompare_parallel`, observations, num_groups, counts_per_category, blume_capel_stats, pairwise_stats, num_categories, main_alpha, main_beta, pairwise_scale, difference_scale, difference_selection_alpha, difference_selection_beta, difference_selection_alpha_between, difference_selection_beta_between, difference_dirichlet_alpha, difference_lambda, difference_prior, iter, warmup, na_impute, missing_data_indices, is_ordinal_variable, baseline_category, difference_selection, main_difference_selection, main_effect_indices, pairwise_effect_indices, target_accept, nuts_max_depth, learn_mass_matrix, projection, group_membership, group_indices, interaction_index_matrix, inclusion_probability, num_chains, nThreads, seed, update_method, progress_type, interaction_prior_type_str, difference_prior_type_str, threshold_prior_type_str, threshold_scale, progress_callback)
}
...
test_parameter_prior <- function(type, x, scale = 1.0, alpha = 0.5, beta = 0.5) {
    .Call(`_bgms_test_parameter_prior`, type, x, scale, alpha, beta)
}
...
zratio_test_spec_eval <- function(zratio_spec, G, edges) {
    .Call(`_bgms_zratio_test_spec_eval`, zratio_spec, G, edges)
}

zratio_test_surface_batch <- function(G, edges, addc, tg, ihat, ghat, wt, psi0, surface, delta, eta, slab_cauchy = FALSE, alpha = 1.0) {
    .Call(`_bgms_zratio_test_surface_batch`, G, edges, addc, tg, ihat, ghat, wt, psi0, surface, delta, eta, slab_cauchy, alpha)
}

zratio_test_gold_moments <- function(G, i, j, addc, tg, ihat, ghat, wt, psi0, delta, eta, n_sweep, burn, seed, slab_cauchy = FALSE, alpha = 1.0) {
    .Call(`_bgms_zratio_test_gold_moments`, G, i, j, addc, tg, ihat, ghat, wt, psi0, delta, eta, n_sweep, burn, seed, slab_cauchy, alpha)
}
