...
sample_omrf_gibbs <- function(no_states, no_nodes, no_categories, interactions, thresholds, no_iterations) {
    .Call(`_bgms_sample_omrf_gibbs`, no_states, no_nodes, no_categories, interactions, thresholds, no_iterations)
}
...
gibbs_sampler <- function(observations, gamma, interactions, thresholds, no_categories, interaction_prior, cauchy_scale, unit_info, proposal_sd, Index, no_iterations, burnin, n_cat_obs, threshold_alpha, threshold_beta, save = FALSE, caching = TRUE, display_progress = FALSE) {
    .Call(`_bgms_gibbs_sampler`, observations, gamma, interactions, thresholds, no_categories, interaction_prior, cauchy_scale, unit_info, proposal_sd, Index, no_iterations, burnin, n_cat_obs, threshold_alpha, threshold_beta, save, caching, display_progress)
}
