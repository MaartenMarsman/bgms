---
title: "Bayesian analysis of the ordinal MRF using the bgm function"
...
This example demonstrates how to use the `bgm` function for the Bayesian analysis of binary or ordinal data using a Markov Random Field (MRF) model. To learn more about the MRF model, check out @MarsmanHaslbeck_2023_ordinal, and to learn more about the Bayesian analysis of network models, check out @HuthEtAl_2023 or @SekulovskiEtAl_2023.
