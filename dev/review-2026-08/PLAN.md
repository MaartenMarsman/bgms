...
| 24 precision_graph_prior default → "hierarchical" (F-010) + F-022 harm wiring + F-103 sweeps program + F-123 (b) guard/hygiene | Opus | **issued 2026-08-03** — `briefs/24-hierarchical-gauge.md`; UN-GATED (MM: "F-103: OK", sweeps-first); third concurrent, ~4 threads, one fit at a time; NEWS as feature wording; docs-site re-bake list in report | handed to MM 2026-08-03 |
