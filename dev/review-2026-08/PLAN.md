...
| 21 mark prior-only compare summary rows (F-117) | Opus | **issued 2026-08-03, LIVE** — `briefs/21-summary-zero-marking.md` stands as written (MM re-ratified after the F-120 detour); REPORT LANDED 2026-08-03 — merge gated on MM: widen-or-narrow, footnote wording, format | handed to MM 2026-08-03 |
