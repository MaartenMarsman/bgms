...
| 21 mark prior-only compare summary rows (F-117) | Opus | **issued 2026-08-03** — `briefs/21-summary-zero-marking.md`; micro-batch, runs alongside 13; MM judges format from report before/after | handed to MM 2026-08-03 |
| 22 compare slab default Cauchy → Normal (F-119) | Opus | QUEUED — draft after 13 merges (test-surface collision); MM-directed NEWS one-liner at integration | — |
