...
| 06 bgmCompare defect + units batch (F-061 sensitivity misalignment FIRST, F-056/F-057 input handling, F-060 verdicts print, F-021 stub, F-063 centrality removal, F-062a–d plots, nats-everywhere conversion, F-065 startup silence) | Opus | **issued 2026-08-01** — repurposed from "cross-path consistency", which moves to brief 09 | pending |
