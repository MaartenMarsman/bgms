...
| 21 mark prior-only compare summary rows (F-117) | Opus | RETIRED unless already launched (MM F-120 ruling supersedes the footnote semantics; marking machinery folds into 22) | superseded 2026-08-03 |
| 22 structural-zero identification fix (F-120: deviation fixed at 0; K>2 scheme to MM) + slab Cauchy → Normal (F-119) + fixed-zero display (F-117 machinery) | Opus | QUEUED — draft after 13 merges; largest remaining pre-release change, instrumented by the F-112 hook; NEWS at integration | — |
